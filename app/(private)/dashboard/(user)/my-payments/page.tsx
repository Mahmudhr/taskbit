    ...
    <div className='space-y-3 md:space-y-6 p-2 md:p-6'>
      ...
      {userSalaries?.data.length === 0 ? (
        ...
        <>
              ...
              <Card className='hidden sm:block'>
                <CardContent className='p-0'>
                  <Table>
                    ...
                    <TableBody>
                      {userSalaries?.data.map((salary, index) => (
          ...
          {userSalaries && userSalaries?.meta.count > 0 && (
            <div className='flex md:flex-row flex-col items-center md:justify-between justify-center gap-3 py-4'>
              <div className='text-sm text-muted-foreground'>
                {userSalaries &&
                  ` Showing ${params.page} to ${
                    userSalaries.meta.page * userSalaries.data.length
                  } of ${userSalaries.meta.count} results`}
              </div>
              <div className='flex items-center space-x-2'>
                ...
                <Button
                  ...
                  disabled={
                    +params.page ===
                    (userSalaries && userSalaries.meta.totalPages)
                  }
                >
                  Next
